...
function original_build()
{
    ...
    ./quick_build.sh P118F userdebug fc new B
}
...
function upload_version(){
    smbclient //10.80.10.2/人工智能bg软件部/ -U gaoyuxia%gyx@2019 -c "cd 人工智能bg软件部\1_正式软件版本\SDA450\X1PRO\B版本;mkdir $VERSION;cd $VERSION;lcd $PRO_PATH/NOHLOS/out;put $VERSION.zip"
}
#####################
main 

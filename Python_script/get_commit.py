...
filename=commands.getoutput('ssh -p 29418 10.80.30.251 gerrit query branch:%s after:%s project:%s status:merged  | grep "subject" > message.txt' % (branch,date_today,project_name))

...
date_today="2019-01-24"
#branch="Stable_Factory32_BRH"
branch="master_32"

D_Time=time.strftime("%Y-%m-%d", time.localtime())
#filename=commands.getoutput('ssh -p 29418 10.80.30.251 gerrit query branch:%s after:%s project:%s status:merged  | grep -aoe "subject[^,]*" > message.txt' % (branch,date_today,project_name))
